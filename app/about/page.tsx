...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-16 py-5 bg-white/95 backdrop-blur-md border-b border-black/5">
        <div className="text-2xl font-bold tracking-widest text-gray-900">
          OPS<span className="text-amber-700">ERA</span>
        </div>
        <div className="flex gap-3 items-center">
          <a href="/" className="text-sm font-medium text-gray-900 px-5 py-2 rounded-full border border-gray-300 hover:bg-gray-100 transition-all">
            Home
          </a>
          <a href="/products" className="text-sm font-medium text-gray-900 px-5 py-2 rounded-full border border-gray-300 hover:bg-gray-100 transition-all">
            Products
          </a>
          <a href="/about" className="text-sm font-medium text-gray-900 px-5 py-2 rounded-full border border-gray-900 bg-gray-900 text-white">
            About Us
          </a>
          <button className="text-sm font-medium text-gray-900 px-5 py-2 rounded-full border border-gray-900 bg-gray-900 text-white hover:bg-gray-800 transition-all">
            Get Started
          </button>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 gap-16 items-center min-h-[500px]">
            ...
            <div className="relative min-h-72">
              {/* Default Hero Text */}
              <motion.div
                className={`transition-all duration-500 ${activePanel ? 'opacity-0 pointer-events-none absolute' : 'opacity-100'}`}
              ...
              >
                ...
                <span className="text-xs text-gray-400 font-normal tracking-wider">
